...
<body class="bg-white text-gray-800">
  ...
  <div class="mx-auto max-w-4xl py-10 px-4">
    ...
    <div class="flex flex-row justify-between items-center mb-6">
      ...
      <a href="dashboard.php" class="bg-pink-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg">
        Kembali
      </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 border border-gray-200">
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <button
          type="submit"
          name="create"
          class="bg-pink-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-lg transition duration-200">
          Simpan
        </button>
      </form>
    </div>
